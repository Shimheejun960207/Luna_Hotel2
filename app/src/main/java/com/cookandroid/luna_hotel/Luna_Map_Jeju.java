...
public class Luna_Map_Jeju extends AppCompatActivity implements OnMapReadyCallback {
   // 지도 변수 선언
    GoogleMap gMap;
    MapFragment mapFrag;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        gMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(33.246313, 126.559628),19));

        // marker 표시
        // market 의 위치, 타이틀, 짧은설명 추가 가능.
        MarkerOptions marker = new MarkerOptions();
        marker .position(new LatLng(33.246313, 126.559628))
                .title("호텔 루나 제주 ")
                .snippet("Hotel Luna -Jeju-");
